...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/categories/export-sql', [CategoryController::class, 'exportSql'])->name('categories.export-sql');
    Route::post('/categories/toggle-auto-export', [CategoryController::class, 'toggleAutoExport'])->name('categories.toggle-auto-export');
    Route::get('/categories/auto-export-status', [CategoryController::class, 'getAutoExportStatus'])->name('categories.auto-export-status');
